    ...
    <div className="container py-5">
      <div className="row ">
        <div className=" col 12 col-xl-6 p-3">
          <h2 className={styles.stylishTitle}>We Create The Art Of Stylish Living Stylishly</h2>
          <p className={styles.stylishDescription}>
          ...
          <Button title="Get Free Estimate" bg="dark" arrow  />

        </div>
        <div className="col-6 d-none d-xl-block">
          <img src="../stylishly.jpg" alt="" className={styles.stylishImage} />
        </div>
      </div>
    </div>
  );
